...
RSpec.describe 'Api::V1::Reports', type: :request do
  ...
  let!(:article3) do
    create(:article, favorability: 'NEUTRAL', user: user, exhibition: exhibition1, publication: publication)
  end
  let!(:article4) do
    create(:article, favorability: 'UNFAVORABLE', user: user, exhibition: exhibition2, publication: publication)
  end
