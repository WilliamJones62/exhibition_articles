...
ActiveRecord::Schema[7.1].define(version: 2025_09_17_133315) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.index ["exhibition_id"], name: "index_articles_on_exhibition_id"
  ...
  add_foreign_key "articles", "exhibitions"
